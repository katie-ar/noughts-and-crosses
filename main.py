...
class box():
    ...
    def drawSelf(self):
        ...
        if self.nought:
            ...
            pygame.draw.line(win, (62, 180, 137), (self.x_pos + 15, self.y_pos + 15),
                             (self.x_pos + 85, self.y_pos + 85), 4)
            pygame.draw.line(win, (62, 180, 137), (self.x_pos + 85, self.y_pos + 15),
                             (self.x_pos + 15, self.y_pos + 85), 4)
...
# there will be an object of this class for the noughts player and for the crosses player
class player():
    # initialisation
...
def gameWindow(boxes, noughts, crosses):
    ...
    # displaying the replay message
    if not crosses.playing and not noughts.playing:
        text = font.render("Press enter to restart the game", 1, (62, 180, 137))
        win.blit(text, (330, 520))
...
run = True
boxes = [box(345, 200), box(450, 200), box(555, 200), box(345, 305), box(450, 305), box(555, 305), box(345, 410),
         box(450, 410), box(555, 410)]
...
while run:
    ...
    for event in pygame.event.get():
        ...
        # checking if the user presses enter to restart the game
        if event.type == pygame.KEYDOWN and gameOver:
            ...
            if keys[pygame.K_RETURN]:
                ...
                noughts.playing = True
                noughts.boxesClicked = []
                noughts.winner = False

                crosses.playing = False
                crosses.boxesClicked = []
                crosses.winner = False
